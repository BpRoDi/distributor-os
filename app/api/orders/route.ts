...
export async function POST(request: Request) {
  try {
    ...
    const { distributorId } = await ensurePilotRows(supabase, input);
    ...
    const eventDetails = { source_channel: input.source_channel, distributor_name: input.distributor_name };
