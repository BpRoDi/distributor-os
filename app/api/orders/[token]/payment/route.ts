...
const PaymentUpdateSchema = z.object({
  ...
  payment_method: z.enum(["bank_transfer", "ach", "wire", "paypal", "card", "apple_pay", "stablecoin_usdc", "offline"]).optional(),
...
export async function POST(
  ...
  try {
    ...
    if (["requested", "partial", "paid"].includes(paymentStatus)) {
      await recordPaymentRequest(supabase, {
        order: existing,
